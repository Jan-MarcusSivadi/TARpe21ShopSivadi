...
namespace TARpe21ShopSivadi.Core.Domain
{
    ...
    public class RealEstate
    {
        ...
        public bool DoesHaveWaterGridConnection { get; set; } //does the propery have connectin to the water grid
        public decimal SqMPrice //whats the price for squery meter in this property
        {
